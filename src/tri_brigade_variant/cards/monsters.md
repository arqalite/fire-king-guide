...
There are currently 10 Tri-Brigade monsters (5 in the main deck and 5 in the extra deck), and 1 extra lore monster that we will glance over (since honestly, it's not good). 

We'll start by talking about the best play maker for this variant [_Tri-Brigade Kitt_], then starters and extenders like [_Tri-Brigade Fraktall_] and [_Tri-Brigade Kerass_]
