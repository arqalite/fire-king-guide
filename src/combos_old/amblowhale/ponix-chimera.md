### Ponix + any Fire King &rarr; Amblowhale (Duelittle Chimera route)

This combo lets you use any FIRE alongside Ponix to Link-climb into [_Amphibious Swarmship Amblowhale_], while putting a Duelittle Chimera in the GY - to be revived later with Amblowhale's effect.

<center>
<video controls>
  <source src="amblowhale/ponix-fire-chimera.mp4" type="video/mp4">
...
#### Outcome
You have a bunch of layered interruptions set up and ready to go; you have a Duelittle Chimera in the GY, ready to be revived off Amblowhale, and additionally, you have Ulcanix in GY which can be revived later to search a [_Fire King Avatar Rangbali_] or anything you might need for the next turn.

#### Interruptions
  - When you are ready, use an effect to destroy Amblowhale.
  - Amblowhale effect to Special Summon Duelittle.
  ...
  - If a Link Monster is destroyed, Amblowhale can banish itself from GY to destroy a card on the field.
    - If the destroyed Link is Duelittle, you also get to recover a FIRE from the GY.
