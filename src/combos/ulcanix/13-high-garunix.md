...
With this starting hand, you can take advantage of [_Fire King High Avatar Garunix_]'s effect and use it to set up your board.
...
>
> Additionally, High Garunix will return from the GY in the Standby Phase and remove both Nibiru and its token.
