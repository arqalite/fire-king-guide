...
<br/><video class="player" controls preload="auto">
  <source src="high-garunix/2-wolf-high-garunix.mp4" type="video/mp4">
...
11. Activate Promethen Princess; Special Summon Arvata from the GY.
12. Link Summon [_Salamangreat Sunlight Wolf_].
13. Pass turn.


#### Opponent's turn
14. In the Standby Phase, activate High Garunix: Special Summon it from the GY, under Sunlight Wolf's link.
15. A chain forms:
...
<details>
  ...
  <br/>
  Regardless of where Nibiru hits, it will prevent you from retrieving Ponix from the GY.
  
  Nothing changes besides that - your first interruption will still be Promethean Princess destroying High Garunix.
</details>