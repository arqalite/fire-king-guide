...
This line is much more greedy - the plan is to end on a [_Salamangreat Sunlight Wolf_] with nothing under its link, backed up by a [_Fire King Avatar Arvata_]. 

Arvata's negate would destroy the [_Legendary Fire King Ponix_] in your hand, triggering the [_Sacred Fire King Garunix_] in your GY, and summoning it under Sunlight Wolf's link. Sunlight Wolf will activate, recovering [_Fire King High Avatar Kirin_] from the GY (or potentially an [_Ash Blossom & Joyous Spring_], if you used it by this point).
...
This route stops [_Nibiru, the Primal Being_], as Arvata is on the field by the 5th summon. However, you'll be forced to destroy Sunlight Wolf if you don't have another FIRE in your hand, so be careful!
...
> Remember Sunlight Wolf's restriction - you are not able to Summon the card you recover with it for the rest of the turn. As such, look to add a card that doesn't need to be Summoned this turn or grab something that can help you prepare for your next turn.