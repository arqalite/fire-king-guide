...
{{#include ulcanix/1-ponix-ulcanix-skyburn.md}}

</div>
<div id="arvata-ulcanix" class="inv">

{{#include ulcanix/2-arvata-ulcanix.md}}

</div>
<div id="princess-arvata" class="inv">

{{#include ulcanix/3-princess-arvata.md}}

</div>
<div id="high-garunix" class="inv">

{{#include ulcanix/4-high-garunix.md}}
