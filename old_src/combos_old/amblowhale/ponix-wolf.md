### Ponix + any Fire King &rarr; Amblowhale (Sunlight Wolf route)

This combo lets you use any FIRE alongside Ponix to Link-climb into [_Amphibious Swarmship Amblowhale_], while recovering a card with [_Salamangreat Sunlight Wolf_].

<center>
<video controls>
  <source src="amblowhale/ponix-fire-wolf.mp4" type="video/mp4">
...
- Link Summon [_Salamangreat Sunlight Wolf_] using Sacred and High Garunix.
- Link Summon [_Salamangreat Almiraj_] using Ponix.
- Activate Sunlight Wolf's effect to recover a card from the GY.
...
#### Outcome
You have a bunch of layered interruptions set up and ready to go. You have a [_Salamangreat Almiraj_] in the GY, ready to be revived off Amblowhale, and additionally, you have Ulcanix in GY which can be revived later to search a [_Fire King Avatar Rangbali_] or anything you might need for the next turn.

#### Interruptions
  - When you are ready, use an effect to destroy Amblowhale.
  - Amblowhale effect to Special Summon Almiraj.
  - Almiraj effect to protect a monster from being destroyed by card effects.
